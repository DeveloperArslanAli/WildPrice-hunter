...
Use these exact answers when completing the **App content** questionnaires in the Google Play Console for **WildPrice Hunter v0.7**.
...
4. **App Bundle**: In **Production** (or **Closed testing** / **Internal testing**), create a new release and drag & drop:
   `WildPriceHunter-v0.7.aab`
5. **Release Notes**: Copy the contents of `PLAY_STORE_LISTING.md` (What's new in v0.7).
